...
> **Note**: > > *Note 12*.
> Note that > > $$2^{10}=1024 \approx 1000 = 10^3$$ > > therefore > > $$2 \approx 10^{3/10}$$ > > so > > $$\log (2) \approx 0.3$$ >
...
Figure: The curve depicts the fuction $y=\ln(x)$ and shows that $\ln$ is the inverse of $\exp$.
